The title for this project is **DATA PROJECT**. The purpose of this project is to apply data cleaning, data structuring methods, data analysis methods and visualize the data.
